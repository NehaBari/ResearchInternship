function [R_in,Q_ik] = orderparameter(student_weights,teacher_weights,K,N,R_in,Q_ik,student_scalar,X,si,tou)
mu = 5;
for i = 1:mu
     ...
     for j = 1:K
       ...
       % if mod(i,P) == 0
          ...
          %  R_in(i,end+1) = dot(student_weights(2,:), teacher_weights(j,:))/N
            ...
            student_weights(j,:) =  (student_weights(j,:) - ((1.5/2)* gradient_epsilon_studentweights'))/N;
         %end
     end
end
