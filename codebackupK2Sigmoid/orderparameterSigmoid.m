function [R,Q,gen_error, student_weights_trained] = orderparameterSigmoid(student_weights,teacher_weights,K,N,psi,tou,learning_rate,i,local_potential_student,X)
...
for j = 1:K
            ...
            gradient_studentweights = (psi - tou(i,:)) * derivativeSigmoid(local_potential_student(j,:))*X;
...
gen_error = generalizationSigmoid(student_weights_trained,teacher_weights,K);
