...
for alphas = 1:size(alphaArray,2)
    for iteration = 1: 10
        ...
        alpha = alphaArray(alphas);%alphaArray(alphas);
        learning_rate = 1;
...
%                      end
            ...
            genErrsmallpleatuematrix(iteration,alphas) = gen_error(3400);
            save('genErrsmallpleatuematrix.mat','genErrsmallpleatuematrix');
            
            genErrsmallconvergedmatrix(iteration,alphas) = gen_error(end);
            ...
            R_pleatuematrix(iteration,:) = [R_11(3400),R_12(3400),R_13(3400),R_14(3400),R_15(3400),R_21(3400),R_22(3400),R_23(3400),R_24(3400),R_25(3400),R_31(3400),R_32(3400),R_33(3400),R_34(3400),R_35(3400),R_41(3400),R_42(3400),R_43(3400),R_44(3400),R_45(3400),R_51(3400),R_52(3400),R_53(3400),R_54(3400),R_55(3400)];
            ...
            R_11_plot_pleatue(iteration,alphas) = R_11(3400);
            R_12_plot_pleatue(iteration,alphas) = R_12(3400);
            R_13_plot_pleatue(iteration,alphas) = R_13(3400);
            R_14_plot_pleatue(iteration,alphas) = R_14(3400);            
            R_15_plot_pleatue(iteration,alphas) = R_15(3400);
            
            
            R_21_plot_pleatue(iteration,alphas) = R_21(3400);
            R_22_plot_pleatue(iteration,alphas) = R_22(3400);
            R_23_plot_pleatue(iteration,alphas) = R_23(3400);
            R_24_plot_pleatue(iteration,alphas) = R_24(3400);
            R_25_plot_pleatue(iteration,alphas) = R_25(3400);
          
            R_31_plot_pleatue(iteration,alphas) = R_31(3400);
            R_32_plot_pleatue(iteration,alphas) = R_32(3400);
            R_33_plot_pleatue(iteration,alphas) = R_33(3400);
            R_34_plot_pleatue(iteration,alphas) = R_34(3400);
            R_35_plot_pleatue(iteration,alphas) = R_35(3400);
           
            
            R_41_plot_pleatue(iteration,alphas) = R_41(3400);
            R_42_plot_pleatue(iteration,alphas) = R_42(3400);
            R_43_plot_pleatue(iteration,alphas) = R_43(3400);
            R_44_plot_pleatue(iteration,alphas) = R_44(3400);
            R_45_plot_pleatue(iteration,alphas) = R_45(3400);
            
            R_51_plot_pleatue(iteration,alphas) = R_51(3400);
            R_52_plot_pleatue(iteration,alphas) = R_52(3400);
            R_53_plot_pleatue(iteration,alphas) = R_53(3400);
            R_54_plot_pleatue(iteration,alphas) = R_54(3400);
            R_55_plot_pleatue(iteration,alphas) = R_55(3400);
          
            save('RPlotpleatue.mat','R_11_plot_pleatue','R_12_plot_pleatue','R_13_plot_pleatue','R_14_plot_pleatue','R_15_plot_pleatue','R_21_plot_pleatue','R_21_plot_pleatue','R_23_plot_pleatue','R_24_plot_pleatue','R_25_plot_pleatue','R_31_plot_pleatue','R_32_plot_pleatue','R_33_plot_pleatue','R_34_plot_pleatue','R_35_plot_pleatue','R_41_plot_pleatue','R_42_plot_pleatue','R_43_plot_pleatue','R_44_plot_pleatue','R_45_plot_pleatue','R_51_plot_pleatue','R_52_plot_pleatue','R_53_plot_pleatue','R_54_plot_pleatue','R_55_plot_pleatue');
            
            R_11_plot_con(iteration,alphas) = R_11(end);
            R_12_plot_con(iteration,alphas) = R_12(end);
            R_13_plot_con(iteration,alphas) = R_13(end);
            R_14_plot_con(iteration,alphas) = R_14(end);
            R_15_plot_con(iteration,alphas) = R_15(end);
           
            R_21_plot_con(iteration,alphas) = R_21(end);
            R_22_plot_con(iteration,alphas) = R_22(end);
            R_23_plot_con(iteration,alphas) = R_23(end);
            R_24_plot_con(iteration,alphas) = R_24(end);
            R_25_plot_con(iteration,alphas) = R_25(end);
           
            R_31_plot_con(iteration,alphas) = R_31(end);
            R_32_plot_con(iteration,alphas) = R_32(end);
            R_33_plot_con(iteration,alphas) = R_33(end);
            R_34_plot_con(iteration,alphas) = R_34(end);
            R_35_plot_con(iteration,alphas) = R_35(end);
           
            
             R_41_plot_con(iteration,alphas) = R_41(end);
             R_42_plot_con(iteration,alphas) = R_42(end);
             R_43_plot_con(iteration,alphas) = R_43(end);
             R_44_plot_con(iteration,alphas) = R_44(end);
             R_45_plot_con(iteration,alphas) = R_45(end);
          
             R_51_plot_con(iteration,alphas) = R_51(end);
             R_52_plot_con(iteration,alphas) = R_52(end);
             R_53_plot_con(iteration,alphas) = R_53(end);
             R_54_plot_con(iteration,alphas) = R_54(end);
             R_55_plot_con(iteration,alphas) = R_55(end);
...
%             
            ...
            filename = '/home/nehabari/Documents/Finalcode/K5Sigmoid';
